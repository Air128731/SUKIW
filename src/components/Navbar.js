          ...
          <div className="max-w-7x px-4 sm:px-8 lg:px-12">
            <div className="relative flex h-16 items-center justify-between">
              {/* <div className="absolute inset-y-0 left-0 flex items-center lg:hidden" style={{width: "120px"}}>
                <img src="img/head_logo.png" style={{minWidth: "120px", maxWidth: "120px"}}></img>
              </div> */}
              ...
              <div className='flex items-center justify-center text-2xl text-white font-bold sm:items-stretch sm:justify-start hover:cursor-pointer'>
                    SUKIW AUTOMATIC TRADING
              </div>
